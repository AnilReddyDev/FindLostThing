  ...
  return (
    <div className=' w-full h-screen bg-white flex  flex-col justify-center items-center'>
      <div className='w-1/4 bg-white rounded-lg p-5 border-b05 border-slate-300 flex flex-col  justify-center items-center'>
          ...
          <input onChange={(e)=> setName(e.target.value)} value={name} type="text" name="name" id="name" placeholder='Name'  className=' w-5/6 border-b05 border-slate-300 text-black font-normal h-16 placeholder:text-slate-600   outline-orange-500 py-2  px-4 text-lg rounded-md mt-4'/>
